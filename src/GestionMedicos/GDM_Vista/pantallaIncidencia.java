...
public class pantallaIncidencia extends PantallaPrincipal {
	...
	public pantallaIncidencia(String nombre, ControladorMed ctrl) {
		super(nombre, ctrl," Informes ","informe.png");
