...
public class ModificarPedido {
		...
		public ModificarPedido() {
		 ...
		 List<TransferProducto_Lab>lista=Controlador_Lab.getInstancia().listarPedido();
			...
			infoPedido.append("Id_Pedido: "+Controlador_Lab.getInstancia().Id_Pedido()+"\n");
			infoPedido.append("Id_Solicitante: "+ Controlador_Lab.getInstancia().Id_Solicitante()+"\n");
			infoPedido.append("NombreSolicitante:: "+ Controlador_Lab.getInstancia().Id_NombreSolicitante()+"\n");
