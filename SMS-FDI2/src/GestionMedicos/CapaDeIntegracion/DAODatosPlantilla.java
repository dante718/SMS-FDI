...
public class DAODatosPlantilla extends ModeloPlantilla {
	...
	private void actualizarPlantillas() {//escribo una nueva linea
		...
		if(ListaPlantillas!=null) {
			cont=this.ListaPlantillas.length+1;
			aux=cont+"\n";
			for(int i=0;i<this.ListaPlantillas.length-1;i++) {

				aux+=this.ListaPlantillas[i].getEstudio()+" "+this.ListaPlantillas[i].getFarmaco()+
						" "+this.ListaPlantillas[i].getEtapa()+"\n";
			}
			aux+=this.ListaPlantillas[this.ListaPlantillas.length-1].getEstudio()+" "+this.ListaPlantillas[this.ListaPlantillas.length-1].getFarmaco()+
					" "+this.ListaPlantillas[this.ListaPlantillas.length-1].getEtapa();
