...
public class MapaFabrica {
	...
	protected Map<String, UsuarioTransfer> mapaUsuario;
	...
	MapaFabrica(){
		...
		this.mapaUsuario = new HashMap<String, UsuarioTransfer>();
	}
	
	void addUsuario(UsuarioTransfer usuario) {
		
		if ( this.mapaUsuario.containsKey(usuario.getDNI())) {
			
		}
		else {
			
			this.mapaUsuario.put(usuario.getDNI(), usuario);
		}
	}
	
	void eliminaUsuario(UsuarioTransfer usuario) {
		
		if (this.mapaUsuario.containsKey(usuario.getDNI())) {
			
			this.mapaUsuario.remove(usuario.getDNI());
		}
		else {
			throw new IllegalArgumentException("MapaFabrica: no existe usuario" + usuario.getDNI());
		}
	}
	...
	boolean contieneUsuario(String i) {
		
		if (this.mapaUsuario.containsKey(i)) {
	...
	public List<UsuarioTransfer> getUsuarios(){
		
		List<UsuarioTransfer> lista = new ArrayList<UsuarioTransfer>(this.mapaUsuario.values());
		return lista;
	}
