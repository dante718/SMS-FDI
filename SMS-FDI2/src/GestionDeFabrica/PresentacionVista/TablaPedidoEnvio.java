...
public class TablaPedidoEnvio extends AbstractTableModel implements FabricaObservadora {
	...
	private final String[] columnNames = {"ID", "Usuario", "Tipo de Envio", "Producto", "Compuesto", "Cantidad", "Estado"};
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 4 : return listaPedidosEnvio.get(rowIndex).getCompuesto();
		
		case 5 : return listaPedidosEnvio.get(rowIndex).getCantidad();
		
		case 6 : return listaPedidosEnvio.get(rowIndex).getEstadoPedido();
