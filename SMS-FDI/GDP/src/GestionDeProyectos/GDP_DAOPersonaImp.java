...
public class GDP_DAOPersonaImp implements GDP_DAOPersona{
	...
	public void inidatos() {
		...
		String line=null;
		BufferedReader read2= new BufferedReader(new FileReader(new File("src/GestionDeProyectos/Proyectos.txt")));
		line=read2.readLine();
	    int tamNif=0;	
		while(line!=null) {
		...
		BufferedReader read3= new BufferedReader(new FileReader(new File("src/GestionDeProyectos/PersonaldeProyectos.txt")));
		line=read3.readLine();
		int i=0, j=0,n=0, k=0;
		while(line!=null) {		
			if(k==n) {
	...
	public void CrearProyecto(GDP_TProyecto proyecto, List<GDP_TPersona> participantes) {
	    ...
	    try {
	    	String line=null;
			BufferedWriter write1= new BufferedWriter(new FileWriter(new File("src/GestionDeProyectos/Proyectos.txt")));
			String s1="";
			...
			BufferedWriter write2= new BufferedWriter(new FileWriter(new File("src/GestionDeProyectos/PersonaldeProyectos.txt")));
			...
			BufferedWriter write3= new BufferedWriter(new FileWriter(new File("src/GestionDeProyectos/Personas.txt")));
